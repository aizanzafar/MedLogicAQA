...
with open('../Data/train_token_lessthan_1000.json','r') as f:
  data=json.load(f)
...
################################################################################
OUTPUT_DIR = "results_token_lessthan_1000" # Output directory where the model predictions and checkpoints will be stored
...
max_seq_length = 1350 # Maximum sequence length to use
