...
with open('../../Data/LU_data/train_LU_model.json','r') as f:
  data=json.load(f)
...
################################################################################
OUTPUT_DIR = "results_LU_model" # Output directory where the model predictions and checkpoints will be stored
