...
with open('../../Data/data_without_rule/train_4234.json','r') as f:
  data=json.load(f)
...
################################################################################
OUTPUT_DIR = "results_llama2_without_rule" # Output directory where the model predictions and checkpoints will be stored
